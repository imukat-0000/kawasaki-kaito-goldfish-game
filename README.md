...
- 金魚は中央から順番に並べず、桶の内側に設定した楕円範囲へランダムに配置
...
- 金魚の種類・向き・位置は各魚の番号で固定し、カウント追加時に既存魚を変更しない
- 1,000匹以降は既存の金魚を置き換えず、赤白・白赤黒・金の鯉を節目ごとに追加
- 大量到達時も軽く動くよう、金魚の代表表示は最大72体、鯉は最終段階で最大10体
