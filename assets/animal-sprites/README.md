...
`color-v2/` contains the preferred natural-color edition: calico cat, Eurasian tree sparrow colors, dark olive-brown tadpole, green frog, and a matching colored metamorphosis sequence. Its chroma-key sources and individual frames are kept inside the same directory.
...
- `color-v2/frog-swim-sprite-sheet.png`: 4 columns x 4 rows. Swim left, swim right, swim front, swim away.
